  ...
  return (
    <>
      <div className="w-full px-3 py-3 bg-[#1976D2] flex rounded">
        <div className="w-1/5 md:w-1/4 justify-center flex items-center">
          <Typography
            variant="h3"
            sx={{
              display: {
        ...
        <div className="w-3/5 md:w-1/2 flex justify-center">
          <div className="searchBox w-4/5 bg-white rounded-[21px] flex flex-row">
            ...
            <IconButton
              type="button"
              sx={{ p: { sm: "10px", xs: "2px" }, height: "auto" }}
              aria-label="search"
            >
              <SearchIcon />
            </IconButton>
        ...
        <div className="w-1/5 md:w-1/4 flex justify-end">
          <div className="account-button flex justify-end gap-2 items-center  lg:w-2/3 md:w-full cursor-pointer">
            <Typography
              variant="h3"
              sx={{
                display: {
